...
`competition/gemastik-2026/technical/IMPLEMENTATION_STATUS.md`.
...
| G9 | Paket GEMASTIK | Proposal, technical document, video script, matrix klaim, lisensi | Folder `competition/gemastik-2026/` dan checklist |
...
- `competition/gemastik-2026/technical/IMPLEMENTATION_STATUS.md` dan
  `competition/gemastik-2026/README.md`.
