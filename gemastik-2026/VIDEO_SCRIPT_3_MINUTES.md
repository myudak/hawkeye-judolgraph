...
The video must record actual local software and the canonical `redirect-new-tab` synthetic run.
Do not composite fake graph data or use a live site as the official demo.

| Time | Visual | Narration / action | Evidence requirement |
|---|---|---|---|
| 00:00–00:15 | Title `[NAMA PRODUK FINAL]`; quick view of evidence chain | “A public URL can become a claim before its evidence is preserved. This tool keeps capture, observation, lead, assertion, and review separate.” | Final name TODO; no unsupported statistics |
