...
SPEC = ROOT / "packaging" / "windows" / "hawkeye.spec"
...
def _copy_distribution_docs() -> None:
    shutil.copy2(ROOT / "packaging" / "windows" / "README-WINDOWS.txt", APP_DIST)
    shutil.copy2(ROOT / "packaging" / "windows" / "settings.env.example", APP_DIST)
